...
public class Wardrobe_page_broken_links extends BaseClass {
    public WebDriver driver;
    @Test()
    public void wardrobe_page_Broken_links() throws IOException, InterruptedException {
        ...
        cu.scroll_down();
        Thread.sleep(2000);
        cu.click_on_element(pm.get_wardrobe_products_menu());
        logger.info("clicked on Wardrobe page menu successfully");
