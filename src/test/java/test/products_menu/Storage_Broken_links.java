...
public class Storage_Broken_links extends BaseClass {
    public WebDriver driver;
    @Test()
    public void Storage_page_Broken_links() throws IOException, InterruptedException {
        ...
        cu.scroll_down();
        Thread.sleep(2000);
        cu.click_on_element(pm.get_storage_products_menu());
        logger.info("clicked on Storage page menu successfully");
