...
public class sofas_Broken_links extends BaseClass {
    public WebDriver driver;
@Test()
public void sofas_Broken_links() throws IOException, InterruptedException {
    ...
    cu.scroll_down();
    Thread.sleep(2000);
    cu.click_on_element(pm.get_sofas_products_menu());
    logger.info("clicked on sofas product page menu successfully");
